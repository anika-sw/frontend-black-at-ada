...
const NewEventForm = () => {
	...
	const addNewEventToApi = (data) => {
		...
		axios
			.post(`${kBaseUrl}/events`, requestBody)
			.then((response) => {
	...
	return (
		<form onSubmit={onFormSubmit} className='eventForm'>
			...
			<div className='form-group form-row'>
				<div className='col'>
					<label>
						For in-person events, enter an address or location below
					</label>
					<div className='map'>
				...
				<div className='col'>
					...
					{image ? (
						<>
							<ImagePreview src={image} alt='event-related image' />
                  ...
                  {' '}to confirm upload of your image
								</p>
                ) : ''
							}
						</>
					...
					{!image && (
						<>
							<label className='custom-file-upload' htmlFor='imageFile'>
								Choose Image
							</label>
							<input
								type='file'
			...
			<p className='instructions'>
				Organizer details are autofilled. If you are not the organizer,
				please update the information below before submitting the event.
			</p>
			<div className='form-group form-row'>
				<div className='col'>
				...
				<div className='col-sm-10'>
					<div className='form-check'>
						<input
							...
							onChange={handleChange}
						></input>
						<label className='form-check-label audience' htmlFor='audienceAllBlackAdies'>
							All Black Adies
						</label>
					</div>
					<div className='form-check'>
						<input
							...
							onChange={handleChange}
						></input>
						<label className='form-check-label audience' htmlFor='audienceBlackAdieAlum'>
							Black Adie Alum
						</label>
					</div>
					<div className='form-check'>
						<input
							...
							onChange={handleChange}
						></input>
						<label className='form-check-label audience' htmlFor='audienceInternBlackAdies'>
					...
					<div className='form-check'>
						<input
							...
							onChange={handleChange}
						></input>
						<label className='form-check-label audience' htmlFor='audienceClassBlackAdies'>
					...
					<div className='form-check'>
						<input
							...
							onChange={handleChange}
						></input>
						<label className='form-check-label audience' htmlFor='audienceAnyone'>
