...
const NewUserForm = () => {
	...
	const handleConfirm = (event) => {
		setConfirm(true);
		setTimeout(() => {
			newUserForm.current.scrollIntoView({
				behavior: 'smooth',
			});
		}, 100);
	};
		...
		<form onSubmit={onFormSubmit} className='user-form'>
				...
				<div className='attestation-flex'>
					...
					<div className='form-check'>
						...
						<label className='form-check-label' htmlFor='blackIdentity'>
							I identify as Black, African, African-American,
							Afro-Carribean, and/or as a part of the African
							diaspora.
						</label>
					</div>
					<input
			...
			<section>
				{adaStudentAlum && blackIdentity && confirm && (
					<>
						<section ref={newUserForm}>
							<h1>Your Information</h1>
							<p>
								All fields marked with an * are required. Your
								name, pronouns (if provided), cohort, LinkedIn
								link (if provided), company (if provided),
								email, and picture will be posted in the Black
								Adie Directory.
							</p>
							...
							<div className='form-row'>
								...
								<div className='col'>
									...
									<button
										type='button'
										className='btn btn-sm btn-secondary password-btn'
                          ...
                          {' '}to confirm upload of your image
									...
									{!image && (
										<>
											<label className='custom-file-upload' htmlFor='profilePicFile'>
												Choose Image
											</label>
											<input
												type='file'
						...
						<section>
							...
							<p>
								Providing information about your current company
								and salary can be very helpful for our
								community. By default, company and salary
								information will be posted anonmously on the
								Salaries page unless otherwise indicated.
							</p>
							<div className='form-row'>
								<div className='col'>
